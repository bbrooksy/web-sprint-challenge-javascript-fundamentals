...
// it is able to access internal because they both belong to the same functions scope and not the global scope.
...
const zooAnimals = [
  ...
  */
  ...
  function lowerCaseNames(zooAnimals){
    const lowName = zooAnimals.map(zooAnimals => {
  ...
  */
  ...
  function lowPopulationAnimals(zooAnimals){
    let lowPop = animalPop => animalPop.population < 5;
  ...
  */
  ...
  function USApop(zooAnimals){
    let toPop = (accumulator , val) => (accumulator + val.population)
    return zooAnimals.reduce(toPop, 0) 
